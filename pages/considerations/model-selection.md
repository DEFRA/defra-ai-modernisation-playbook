...
- **How to override the model** depends on your AI coding assistant. For example, in Claude Code, pass the `--model` flag at launch. Consult the [Tooling]({{ '/pages/reverse-engineering/tooling/' | relative_url }}) section for tool-specific instructions.
